  ...
  return (
    ...
    >
      ...
      <div className='flex flex-wrap justify-center gap-2 text-lg text-gray-800 mt-10 '>
        ...
        <a href="https://api.badgr.io/public/assertions/cpCCEA3JRkyKWGfCssi22g?identity__email=mihiranganayana%40gmail.com" target='_blank'><Image src='/Postman-StudentExpert.png' alt={'img'} width='250' height='250' quality='95' priority={true} className='h-50 w-40 object-cover border-[0.25rem] border-gray dark:bg-white '/></a>
        <a href="https://badgr.com/public/assertions/ZfyxHKzAR_a1qcDNU6jAfQ?identity__email=mihiranganayana@gmail.com" target='_blank'><Image src='/Postman-Test-Automation.png' alt={'img'} width='250' height='250' quality='95' priority={true} className='h-50 w-40 object-cover border-[0.25rem] border-gray dark:bg-white '/></a>
